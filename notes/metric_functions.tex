...
Evaluating (1) with the ansatz:

\begin{align}
  a(1+\frac{C}{r}a^{-1}) = e^\beta (\frac{1}{2}r^2\vartheta_{\tau}^2 + a + 3n^2f^2r^2\vartheta_{\tau}^2) \nonumber \\
  a + \frac{C}{r} = e^\beta (\frac{1}{2}r^2\vartheta_{\tau}^2 + a + 3n^2f^2r^2\vartheta_{\tau}^2) \nonumber \\
  e^\beta = (\frac{1}{2}r^2\vartheta_{\tau}^2 + a + 3n^2f^2r^2\vartheta_{\tau}^2)^{-1} \nonumber \\
  e^\beta = \left( a + r^{2} \vartheta_{\tau}^{2} \left( \tfrac{1}{2} + 3 n^{2} f^{2} \right) \right)^{-1} \nonumber \\
