...
\begin{equation}
  \dd{s^2} = -\left(1 - \frac{C}{r}\right)\dd{\tau^2} + \left(1 - \frac{C}{r}\right)^{-1} \Omega \dd{r^2} + r^2\dd{\theta^2} + r^2\sin^2{\theta}\dd{\varphi^2}
\end{equation}
where $\Omega$ is the torsional correction term
\begin{equation*}
  \Omega = \left( 1 + \frac{r^{2} \vartheta_{\tau}^{2} \left( \tfrac{1}{2} + 3 n^{2} f^{2} \right)}{1 - \frac{C}{r}} \right)^{-1}
\end{equation*}

Because $\vartheta_\tau$ is constant, the torsional correction $\Omega$ remains constant, effectively rescaling the radial metric component.
\end{document}